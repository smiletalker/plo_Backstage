<template>
  ...
  <div class="bigbox">
    ...
    <div class="wobox" v-show="isShow">
      <div class="smallbox">
        <i class="el-icon-close" style="cursor: pointer" @click="isShow=!isShow"></i>
        <img src="../../static/images/wuliu.png" alt="">
      </div>
    </div>
    ...
    <el-table ref="multipleTable" :data="tables.slice((currentPage-1)*pagesize,currentPage*pagesize)" tooltip-effect="dark" style="width: 100%"
      ...
      <template slot-scope="scope">
        ...
        <i class="el-icon-location-outline" @click="isShow=!isShow" style="cursor: pointer"></i>
      </template>
    </el-table-column>
...
<script>
  ...
  export default {
   ...
   created(){
    var that=this;
    this.$axios.get('/api/orertable3.do')
      .then(function (resp) {
        console.log("请求成功");
        console.log(resp);
