  ...
  <div>
    ...
    <div class="bigbox">
      ...
      <el-table ref="multipleTable"
        ...
        <el-table-column prop="exeName" label="所属分类" width="120"></el-table-column>
    ...
    export default {
      ...
      data() {
        return {
          tableData: [],
          clothmp:[
            {goodsId:1,exeName:'滑雪',goodsName:'女士运动长裤',price:'199.00',state:"上架",num:"132"},
            {goodsId:2,exeName:'滑雪',goodsName:'女士Threadborne Siro长裤',price:'199.00',state:"上架",num:"96"},
            {goodsId:3,exeName:'滑雪',goodsName:'男士Swacket长裤',price:'199.00',state:"上架",num:"345"},
            {goodsId:4,exeName:'滑雪',goodsName:'男士Center Court Print',price:'199.00',state:"上架",num:"226"},
            {goodsId:5,exeName:'滑雪',goodsName:'女士运动长裤',price:'199.00',state:"上架",num:"143"},
            {goodsId:6,exeName:'滑雪',goodsName:'女士Threadborne Siro长裤',price:'199.00',state:"上架",num:"156"},
            {goodsId:7,exeName:'攀岩',goodsName:'男士Swacket长裤',price:'199.00',state:"上架",num:"123"},
            {goodsId:8,exeName:'攀岩',goodsName:'男士Center Court Print',price:'199.00',state:"上架",num:"656"},
            {goodsId:9,exeName:'攀岩',goodsName:'女士运动长裤',price:'199.00',state:"上架",num:"345"},
            {goodsId:10,exeName:'徒步旅行',goodsName:'女士Threadborne Siro长裤',price:'199.00',state:"上架",num:"356"},
            {goodsId:11,exeName:'徒步旅行',goodsName:'男士Swacket长裤',price:'199.00',state:"上架",num:"353"},
            {goodsId:12,exeName:'徒步旅行',goodsName:'男士Center Court Print',price:'199.00',state:"上架",num:"656"},
            ],
          // newData:[],
          stock:[],
          lookbox:'',
      ...
      computed:{
        newData(){
          ...
          return this.clothmp.filter(function (values) {
            return values.exeName.indexOf(that.getSelect)!=-1 && values.goodsName.indexOf(that.getNm)!=-1
